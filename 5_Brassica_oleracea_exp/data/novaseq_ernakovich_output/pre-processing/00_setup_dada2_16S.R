...
data.fp <- "/lustre/BIF/nobackup/berda001/novaseq_data/seq4/Zulema/16S"
...
project.fp <- "/lustre/BIF/nobackup/berda001/ernakovich_lab_pipeline/Zulema/16S" # CHANGE ME to project directory; don't append with a "/"
